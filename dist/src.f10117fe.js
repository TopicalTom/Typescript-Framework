...
exports.View = void 0; // Extends props
...
var View_1 = require("./View"); // Passes both class and props into View class
...
function (_super) {
  ...
  function UserForm() {
    ...
    _this.onSetNameClick = function () {
      var input = _this.parent.querySelector('input'); // Type guard against 'null' cases
...
;
},{"./View":"src/views/View.ts","./UserForm":"src/views/UserForm.ts","./UserShow":"src/views/UserShow.ts"}],"src/models/Eventing.ts":[function(require,module,exports) {
"use strict";
...
var root = document.getElementById('root'); // Type guard against 'null'
